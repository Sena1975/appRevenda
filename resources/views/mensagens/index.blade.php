                ...
                <table class="min-w-full divide-y divide-gray-200 text-xs sm:text-sm">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-2 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">Data envio</th>
                            <th class="px-2 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">Cliente</th>
                            <th class="px-2 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">Pedido</th>
                            <th class="px-2 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">Campanha</th>
                            ...
                            <th class="px-2 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">Canal</th>
                            <th class="px-2 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">Direção</th>
                            <th class="px-2 py-2 text-left font-medium text-gray-500 uppercase tracking-wider">Preview</th>
                        </tr>
                    </thead>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-2 py-2 whitespace-nowrap text-gray-700">
                                    <a href="{{ route('mensagens.show', $msg) }}"
                                       title="Ver detalhes completos desta mensagem"
                                ...
                                {{-- Cliente com link opcional e tooltip --}}
                                <td class="px-2 py-2 whitespace-nowrap text-gray-700">
                                    @if($msg->cliente)
                                        @if(Route::has('clientes.show'))
                                            <a href="{{ route('clientes.show', $msg->cliente) }}"
                                ...
                                {{-- Pedido com link opcional e tooltip --}}
                                <td class="px-2 py-2 whitespace-nowrap text-gray-700">
                                    @if($msg->pedido_id)
                                        @if(Route::has('vendas.show'))
                                            <a href="{{ route('vendas.show', $msg->pedido_id) }}"
                                ...
                                {{-- Campanha com link opcional e tooltip --}}
                                <td class="px-2 py-2 whitespace-nowrap text-gray-700">
                                    @if($msg->campanha)
                                        @if(Route::has('campanhas.show'))
                                            <a href="{{ route('campanhas.show', $msg->campanha) }}"
