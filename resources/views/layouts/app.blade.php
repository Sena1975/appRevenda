...
<body class="bg-gray-100 min-h-screen antialiased" x-data="{
    /* MENU LATERAL */
    sidebarOpen: false,
    ...
    <div class="relative z-40 lg:hidden" x-show="sidebarOpen" x-cloak>
        <div class="fixed inset-0 bg-gray-900/50" @click="sidebarOpen=false" x-show="sidebarOpen" x-transition.opacity>
        </div>

        <div class="fixed inset-y-0 left-0 max-w-full flex">
            <div class="w-72 bg-white shadow-xl" x-show="sidebarOpen"
    ...
    <div class="lg:pl-64 flex flex-col min-h-screen">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button type="button"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                            <path
                                d="M12 2a2 2 0 00-2 2c0 1.5 2 3 2 3s2-1.5 2-3a2 2 0 00-2-2zm7 10H5a3 3 0 00-3 3v5h20v-5a3 3 0 00-3-3zM3 18h18v2H3v-2z" />
                        </svg>
                        Aniversariantes
                    </button>
                </div>
        ...
        <div class="relative z-30" x-cloak x-show="aniversOpen">
            ...
            <div class="fixed inset-y-0 left-0 lg:left-64 flex">
                <div class="w-[22rem] bg-white shadow-xl flex flex-col" x-show="aniversOpen"
                    x-transition:enter="transform transition ease-out duration-200"
                    x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0"
                    ...
                    <div class="px-4 py-3 border-b flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            ...
                            <select class="border rounded-md text-sm px-2 py-1" x-model.number="mesSel"
                                @change="carregarAniversariantes()">
                                <template x-for="m in 12" :key="m">
                                    <option :value="m"
                                        x-text="new Date(2000,m-1,1).toLocaleString('pt-BR',{month:'long'})"></option>
                                </template>
                            </select>
                        </div>
                        <button class="rounded-md p-1 hover:bg-gray-100" @click="aniversOpen=false" aria-label="Fechar">
                            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                                <path
                                    d="M18.3 5.71L12 12l6.3 6.29-1.41 1.42L10.59 13.4 4.29 19.7 2.88 18.29 9.17 12 2.88 5.71 4.29 4.3l6.3 6.29 6.29-6.3z" />
                            </svg>
                        </button>
                    </div>
                    ...
                    <div class="flex-1 overflow-y-auto">
                        ...
                        <ul class="divide-y">
                            <template x-for="p in lista" :key="p.id">
                                <li class="aniv-item px-4 py-3 flex items-center gap-3"
