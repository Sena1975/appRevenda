        ...
        <form action="{{ route('tabelapreco.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="produto_id" class="w-full border-gray-300 rounded-md shadow-sm" required>
                        ...
                        @foreach($produtos as $produto)
                            <option value="{{ $produto->id }}" {{ (string)old('produto_id')===(string)$produto->id?'selected':'' }}>
                ...
                <div>
                    ...
                    <input type="text" name="codfab" value="{{ old('codfab') }}"
                           class="w-full border-gray-300 rounded-md shadow-sm" placeholder="Ex: NT-001">
                </div>
