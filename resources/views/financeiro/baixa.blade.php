...
<div class="max-w-xl mx-auto p-6 bg-white rounded shadow">
    <h1 class="text-xl font-semibold mb-4">Baixar Parcela #{{ $conta->id }}</h1>
    ...
    <div class="mb-4 text-sm text-gray-700">
        <p><strong>Cliente:</strong> {{ $conta->cliente->nome ?? '-' }}</p>
    ...
    <form method="POST" action="{{ route('contasreceber.baixa.store', $conta->id) }}">
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div>
                ...
                <textarea name="observacao" rows="3" class="w-full border rounded px-3 py-2"
