<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-gray-700">Cadastrar Supervisor</h2>
    </x-slot>
        ...
        <form action="{{ route('supervisores.store') }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" name="datanascimento" class="w-full border-gray-300 rounded-md shadow-sm">
                </div>

                <div class="col-span-2">
                    <label class="block text-sm font-medium text-gray-700">CEP</label>
                    <input type="text" name="cep" id="cep" class="w-full border-gray-300 rounded-md shadow-sm" onblur="buscarCEP()">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="estado" id="estado" class="w-full border-gray-300 rounded-md shadow-sm">
                </div>
